                    ...
                    >
                        <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[30rem] sm:p-6">
                            ...
                            <div class="text-start">
                                ...
                                <div
                                    class="cursor-pointer mt-3 p-3 bg-[#222] rounded shadow-md text-[#fff] flex items-center justify-center gap-2"
                                ...
                                <div
                                    class="cursor-pointer mt-3 p-3 border-1px border-[#ccc] rounded shadow-md text-[#222] flex items-center justify-center gap-2"
                                    @click="onClickOutside()"
                                >
